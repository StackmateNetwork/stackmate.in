---
title: "Bitcoin Key Recovery"
description: "Demonstrates how to use your seed to recover your bitcoin for a solo account."
authors: 
    - Vishal Menon
date: "2021-02-23"
tags: ["guide", "recovery"]
...
```bash
bdk-cli key restore --mneumonic "witness poverty pulse crush era item game rose bargain quantum spawn sure way behave also basket journey worry stem entry toddler floor way bone" |  tee apna-key.json
{
